...
router.get('/', async (req, res) => {
	...
	async function PRINCE_JUNIOR_V2_QR_CODE() {
		...
		try {
			let Qr_Code_By_prince_junior_Tech = Prince_Junior_Tech({
				auth: state,
...
╔═════◇
║  『••• 𝗩𝗶𝘀𝗶𝘁 𝗙𝗼𝗿 𝗛𝗲𝗹𝗽 •••』
║❒ *Ytube:* _https://www.youtum/@BTSMODZ
║❒ *Owner:* https://wa.me/254723245807_
...
║❒ *Plugins:* _https://github.com/Nyanuga-Nyanuga 
╚════════════════════════╝
